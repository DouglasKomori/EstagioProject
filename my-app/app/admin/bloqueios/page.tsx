...
export default function GerenciarBloqueios() {
  ...
  const formatarData = (dataStr: string) => new Date(dataStr).toLocaleDateString('pt-BR', { timeZone: 'America/Sao_Paulo' });
  const formatarHora = (dataStr: string) => new Date(dataStr).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit', timeZone: 'America/Sao_Paulo' });
