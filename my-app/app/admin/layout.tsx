    ...
    <div className="min-h-screen w-full bg-zinc-950 text-zinc-50 font-sans flex flex-col overflow-x-hidden relative">
      ...
      >
        <div className="p-6 flex flex-col h-full">
          ...
          {/* Links do Menu (Navegação do Painel) */}
          <nav className="flex flex-col gap-2">
            <Link href="/admin" className="flex items-center gap-4 px-4 py-3 rounded-lg text-zinc-300 hover:text-[#E4B77D] hover:bg-zinc-900/50 transition-all group">
