      ...
      <main className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white group-hover:text-[#E4B77D] transition-colors">Caixa / Comandas</h3>
            <p className="text-zinc-400 mt-2 text-sm">Abrir fichas, lançar consumos e fechar contas.</p>
          </Link>
