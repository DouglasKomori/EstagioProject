...
export default class AgendamentoRepository {
    ...
    async cadastrar(agendamento) {
        try {
            ...
            let agendamentoId = await this.#banco.ExecutaComandoLastInserted(sqlAgendamento, paramsAgendamento);
    ...
    async emitirRelatorioAgenda(filtros) {
        ...
        sql += " GROUP BY a.id, a.dataHora, a.status, c.nome, c.telefone, p.nome, a.ativo";
